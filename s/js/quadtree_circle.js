    ...
    */
    ...
    Quadtree.prototype.getIndex = function( circle ) {
        ...
        var 	index 			= -1,
            ...
            topQuadrant = (circle.y < horizontalMidpoint && circle.y + circle.r < horizontalMidpoint),
            
            //circle can completely fit within the bottom quadrants
            bottomQuadrant = (circle.y > horizontalMidpoint );
         
        //circle can completely fit within the left quadrants
        if( circle.x < verticalMidpoint && circle.x + circle.r < verticalMidpoint ) {
            if( topQuadrant ) {
                index = 1;
        ...
        } else if( circle.x > verticalMidpoint ) {
            if( topQuadrant ) {
                index = 0;
            } else if( bottomQuadrant ) {
                index = 3;
